package edson.com.imotosconductor.adapter;
...
import edson.com.imotosconductor.ConfirmarCancelacion;
import edson.com.imotosconductor.R;
import edson.com.imotosconductor.clienteHTTP.HttpConnection;
import edson.com.imotosconductor.clienteHTTP.MethodType;
import edson.com.imotosconductor.clienteHTTP.StandarRequestConfiguration;
import edson.com.imotosconductor.utiles.Contexto;
...
public class cancelar_ListAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (view == null) {
            view = LayoutInflater.from(contexto).inflate(R.layout.layou_list_marca, viewGroup, false);
        }
